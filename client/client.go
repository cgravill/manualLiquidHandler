// client/client.go: Part of the Antha language
...
import (
	...
	"github.com/antha-lang/manualLiquidHandler/internal/google.golang.org/grpc"
...
func DecodeLHProperties(arg *pb.LHPropertiesMessage) i_3.LHProperties {
	ret := i_3.LHProperties{(string)(arg.Arg_1), (int)(arg.Arg_2), (map[string]*i_1.LHPosition)(DecodeMapstringPtrToLHPositionMessage(arg.Arg_3)), (map[string]interface{})(DecodeMapstringinterfaceMessage(arg.Arg_4)), (map[string]string)(DecodeMapstringstringMessage(arg.Arg_5)), (map[string]string)(DecodeMapstringstringMessage(arg.Arg_6)), (map[string]*i_1.LHPlate)(DecodeMapstringPtrToLHPlateMessage(arg.Arg_7)), (map[string]*i_1.LHTipbox)(DecodeMapstringPtrToLHTipboxMessage(arg.Arg_8)), (map[string]*i_1.LHTipwaste)(DecodeMapstringPtrToLHTipwasteMessage(arg.Arg_9)), (map[string]*i_1.LHPlate)(DecodeMapstringPtrToLHPlateMessage(arg.Arg_10)), (map[string]*i_1.LHPlate)(DecodeMapstringPtrToLHPlateMessage(arg.Arg_11)), (map[string]string)(DecodeMapstringstringMessage(arg.Arg_12)), (string)(arg.Arg_13), (string)(arg.Arg_14), (string)(arg.Arg_15), (string)(arg.Arg_16), ([]*i_1.LHHead)(DecodeArrayOfPtrToLHHead(arg.Arg_17)), ([]*i_1.LHHead)(DecodeArrayOfPtrToLHHead(arg.Arg_18)), ([]*i_1.LHAdaptor)(DecodeArrayOfPtrToLHAdaptor(arg.Arg_19)), ([]*i_1.LHTip)(DecodeArrayOfPtrToLHTip(arg.Arg_20)), ([]string)(DecodeArrayOfstring(arg.Arg_21)), ([]string)(DecodeArrayOfstring(arg.Arg_22)), ([]string)(DecodeArrayOfstring(arg.Arg_23)), ([]string)(DecodeArrayOfstring(arg.Arg_24)), ([]string)(DecodeArrayOfstring(arg.Arg_25)), ([]string)(DecodeArrayOfstring(arg.Arg_26)), nil, (*i_1.LHChannelParameter)(DecodePtrToLHChannelParameter(arg.Arg_27)), ([]*i_1.LHChannelParameter)(DecodeArrayOfPtrToLHChannelParameter(arg.Arg_28)), (map[string]i_1.Coordinates)(DecodeMapstringCoordinatesMessage(arg.Arg_29)), (material.MaterialType)(arg.Arg_30)}
	return ret
}
...
func EncodePtrToGenericEntity(arg *i_1.GenericEntity) *pb.PtrToGenericEntityMessage {
	ret := pb.PtrToGenericEntityMessage{
		EncodeGenericEntity(*arg),
	}
	return &ret
}
func DecodePtrToGenericEntity(arg *pb.PtrToGenericEntityMessage) *i_1.GenericEntity {
	if arg == nil {
...
func EncodeGenericSolid(arg i_1.GenericSolid) *pb.GenericSolidMessage {
	ret := pb.GenericSolidMessage{EncodeGenericPhysical(arg.GenericPhysical), EncodePtrToShape(arg.Myshape)}
	return &ret
}
func DecodeGenericSolid(arg *pb.GenericSolidMessage) i_1.GenericSolid {
	ret := i_1.GenericSolid{(i_1.GenericPhysical)(DecodeGenericPhysical(arg.Arg_1)), (*i_1.Shape)(DecodePtrToShape(arg.Arg_2))}
	return ret
}
...
func EncodeGenericEntity(arg i_1.GenericEntity) *pb.GenericEntityMessage {
	ret := pb.GenericEntityMessage{EncodePtrToGenericSolid(arg.GenericSolid), EncodePtrToConcreteLocation(arg.Loc)}
	return &ret
}
func DecodeGenericEntity(arg *pb.GenericEntityMessage) i_1.GenericEntity {
	ret := i_1.GenericEntity{(*i_1.GenericSolid)(DecodePtrToGenericSolid(arg.Arg_1)), (*i_1.ConcreteLocation)(DecodePtrToConcreteLocation(arg.Arg_2))}
	return ret
}
...
func EncodePtrToGenericSolid(arg *i_1.GenericSolid) *pb.PtrToGenericSolidMessage {
	ret := pb.PtrToGenericSolidMessage{
		EncodeGenericSolid(*arg),
	}
	return &ret
}
func DecodePtrToGenericSolid(arg *pb.PtrToGenericSolidMessage) *i_1.GenericSolid {
	if arg == nil {
...
func DecodeLHWell(arg *pb.LHWellMessage) i_1.LHWell {
	ret := i_1.LHWell{(string)(arg.Arg_1), (string)(arg.Arg_2), (string)(arg.Arg_3), (string)(arg.Arg_4), (string)(arg.Arg_5), (string)(arg.Arg_6), (float64)(arg.Arg_7), (string)(arg.Arg_8), ([]*i_1.LHComponent)(DecodeArrayOfPtrToLHComponent(arg.Arg_9)), (float64)(arg.Arg_10), (float64)(arg.Arg_11), (*i_1.Shape)(DecodePtrToShape(arg.Arg_12)), (int)(arg.Arg_13), (float64)(arg.Arg_14), (float64)(arg.Arg_15), (float64)(arg.Arg_16), (float64)(arg.Arg_17), (string)(arg.Arg_18), (map[string]interface{})(DecodeMapstringinterfaceMessage(arg.Arg_19)), nil}
	return ret
}
...
func EncodeGenericPhysical(arg i_1.GenericPhysical) *pb.GenericPhysicalMessage {
...
func DecodeGenericPhysical(arg *pb.GenericPhysicalMessage) i_1.GenericPhysical {
	ret := i_1.GenericPhysical{(i_1.GenericMatter)(DecodeGenericMatter(arg.Arg_1)), (string)(arg.Arg_2), (i_2.Mass)(DecodeMass(arg.Arg_3)), (i_2.Volume)(DecodeVolume(arg.Arg_4)), (i_2.Temperature)(DecodeTemperature(arg.Arg_5))}
	return ret
}
...
func EncodeGenericMatter(arg i_1.GenericMatter) *pb.GenericMatterMessage {
...
func DecodeGenericMatter(arg *pb.GenericMatterMessage) i_1.GenericMatter {
	ret := i_1.GenericMatter{(string)(arg.Arg_1), (i_2.Temperature)(DecodeTemperature(arg.Arg_2)), (i_2.Temperature)(DecodeTemperature(arg.Arg_3)), (i_2.SpecificHeatCapacity)(DecodeSpecificHeatCapacity(arg.Arg_4))}
	return ret
}
...
func EncodePtrToGenericPhysical(arg *i_1.GenericPhysical) *pb.PtrToGenericPhysicalMessage {
	ret := pb.PtrToGenericPhysicalMessage{
		EncodeGenericPhysical(*arg),
	}
	return &ret
}
func DecodePtrToGenericPhysical(arg *pb.PtrToGenericPhysicalMessage) *i_1.GenericPhysical {
	if arg == nil {
...
func (d *Driver) GetStatus() (map[string]interface{}, i_4.CommandStatus) {
	req := pb.GetStatusRequest{}
	ret, _ := d.C.GetStatus(context.Background(), &req)
	return (map[string]interface{})(DecodeMapstringinterfaceMessage(ret.Ret_1)), (i_4.CommandStatus)(DecodeCommandStatus(ret.Ret_2))
}
...
func (d *Driver) SetPositionState(arg_1 string, arg_2 map[string]interface{}) i_4.CommandStatus {
